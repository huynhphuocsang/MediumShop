...
<link rel="stylesheet" href='<c:url value="/resources/cssAdmin/bootstrap.min.css"/>' type='text/css'>
<!-- Custom CSS -->
<link rel="stylesheet" href='<c:url value="/resources/cssAdmin/style.css"/>' type='text/css'>
<link rel="stylesheet" href='<c:url value="/resources/cssAdmin/morris.css"/>' type='text/css'>
<!-- Graph CSS -->
<link rel="stylesheet" href='<c:url value="/resources/cssAdmin/font-awesome.css"/>'>
<!-- jQuery -->
<script src='<c:url value="/resources/jsAdmin/jquery-2.1.4.min.js"/>'></script>
<!-- //jQuery -->
<link href='//fonts.googleapis.com/css?family=Roboto:700,500,300,100italic,100,400' rel='stylesheet' type='text/css'/>
<link href='//fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
<!-- lined-icons -->
<link rel="stylesheet" href='<c:url value="/resources/cssAdmin/icon-font.min.css" />'>
<!-- //lined-icons -->
</head> 
<body>
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>
										 ...
										 <li id="menu-academico" ><a href='<c:url value="/themsanpham"/>'><i class="fa fa-product-hunt"></i><span>Sản phẩm</span><div class="clearfix"></div></a></li>
